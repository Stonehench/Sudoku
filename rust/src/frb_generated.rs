...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        5 => wire_check_legality_impl(port, ptr, rust_vec_len, data_len),
        7 => wire_close_threads_impl(port, ptr, rust_vec_len, data_len),
        8 => wire_difficulty_values_impl(port, ptr, rust_vec_len, data_len),
